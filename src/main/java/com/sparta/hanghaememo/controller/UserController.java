...
import com.sparta.hanghaememo.service.KakaoService;
...
public class UserController {
    ...
    public String kakaoLogin(@RequestParam String code, HttpServletResponse response) throws JsonProcessingException, JsonProcessingException {
